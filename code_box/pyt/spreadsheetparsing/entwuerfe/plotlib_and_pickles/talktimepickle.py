...
def check_cmdline_params():
    if len(sys.argv) != 3:
        ...
        print
        print(textwrap.fill("2. Argument ist die Ziel-PKL-Datei",80))
        print
...
doe_frame = pandas.DataFrame(doe)
#[column_order] # This df contains ALL files that were scanned in the input_dir
...
print(doe_frame)
doe_frame.to_pickle(sys.argv[2])
